...
public class ScopusExtraction {
	...
	public static void main(String[] args) throws IOException {
		//		String authorID = getJsonAuthor("Micarelli", "Alessandro", "Roma Tre");
//		Set<String> documentIDs = getJsonDocument("");
...
//		JsonObject pages = (JsonObject) jsonElement.getAsJsonArray().get(0);
