...
public class TagMeExtraction {
	...
	private static Set<String> getJsonDocument(String text) throws IOException{
		text.replace(" ", "+");
		URL url = new URL("http://tagme.di.unipi.it/tag?text="+text+"&key=8020b57e2d41b6041c4fd06937acbec7&include_categories=true&long_text=true");
